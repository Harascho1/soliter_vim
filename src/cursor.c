...
CURSOR*
create_cursor(FIELD *field,int col, int row) {
    ...
    cursor->cursor->y = field->gameplay_screen_padding_height + field->card_padding_height + field->card_height - field->cursor_padding;
